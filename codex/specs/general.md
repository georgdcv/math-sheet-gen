...
Zahlen vergleichen (compare_numbers)
...
Vorgänger / Zahl / Nachfolger (pre_succ_table)
...
Rechnen in einer Liste (arithmetic_list)
...
Zahlwort – Würfelbild – Zahl (number_word_table)
...
Rechentabellen (operation_table)
...
Die Spezifikation ist so angelegt, dass du später weitere types ergänzen kannst.
...
Globalen Zufallszahlgenerator (z. B. random.Random(seed + worksheet_index)) initialisieren.

Für jede worksheet_index in 0..count-1:
...
actions/setup-python@v5 mit Python 3.x.
